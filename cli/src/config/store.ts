...
import { taskcoreConfigSchema, type TaskcoreConfig } from "./schema.js";
...
export function readConfig(configPath?: string): TaskcoreConfig | null {
...
export function writeConfig(config: TaskcoreConfig, configPath?: string): void {
  const filePath = resolveConfigPath(configPath);
