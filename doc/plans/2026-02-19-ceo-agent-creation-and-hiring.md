...
- installed adapter list for this Taskcore instance
...
## 8. New Skill: `taskcore-create-agent`

Create new skill directory:

- `skills/taskcore-create-agent/SKILL.md`
...
Also update `skills/taskcore/SKILL.md` to reference this skill for hiring workflows.
...
- `taskcore-create-agent` skill + docs updates
