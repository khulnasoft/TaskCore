...
name: design-guide
description: >
  Taskcore UI design system guide for building consistent, reusable frontend
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Taskcore-specific design language.
