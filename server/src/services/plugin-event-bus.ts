/**
 * PluginEventBus — typed in-process event bus for the Taskcore plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@taskcore/shared";
import type { PluginEvent, EventFilter } from "@taskcore/plugin-sdk";
