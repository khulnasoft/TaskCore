...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Taskcore state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".taskcore/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/taskcore",
      ),
    ).toBe(false);
