...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://taskcore:taskcore@127.0.0.1:5432/taskcore",
    embeddedPostgresDataDir: "/tmp/taskcore-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/taskcore-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/taskcore-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/taskcore-storage",
    storageS3Bucket: "taskcore-test",
