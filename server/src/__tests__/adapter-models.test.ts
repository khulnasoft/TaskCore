...
import { resetOpenCodeModelsCacheForTests } from "@taskcore/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.TASKCORE_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.TASKCORE_OPENCODE_COMMAND = "__taskcore_missing_opencode_command__";
