...
Manage companies within your Taskcore instance.
...
Company logo uploads use the normal Taskcore attachment size limit.
...
| `logoUrl`            | string | Optional Taskcore asset content path for the stored logo image |
