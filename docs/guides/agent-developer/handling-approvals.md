...
- `TASKCORE_APPROVAL_ID` — the resolved approval
- `TASKCORE_APPROVAL_STATUS` — `approved` or `rejected`
- `TASKCORE_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
