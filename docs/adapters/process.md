...
- Running a Python script that calls the Taskcore API
...
1. Taskcore spawns the configured command as a child process
2. Standard Taskcore environment variables are injected (`TASKCORE_AGENT_ID`, `TASKCORE_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Taskcore API and perform work.
